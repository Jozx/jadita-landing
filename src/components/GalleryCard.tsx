  ...
  return (
    <article className="group flex flex-col bg-bg border border-primary/10 rounded-2xl shadow-sm overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="w-full py-4 px-4 flex flex-col">
        ...
        {product.description && (
          <p className="mt-1 font-body text-xs text-text/55 leading-relaxed">{product.description}</p>
        )}
        ...
        <ExternalLink
          ...
          className="mt-3 w-full flex items-center justify-center 
                     gap-2 py-2.5 rounded-full text-sm font-semibold
                     bg-[#C4724A] text-white hover:bg-[#8B3A2A]
