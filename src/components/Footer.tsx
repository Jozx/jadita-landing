...
const Footer: React.FC<FooterProps> = ({ brand, channels }) => {
  return (
    <footer className="bg-bg py-8 border-t border-primary/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="flex space-x-6">
            {channels?.whatsapp && (
              <ExternalLink
                ...
                className="text-primary hover:text-accent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded"
                ariaLabel="WhatsApp"
              >
          ...
          <p className="font-body text-sm text-accent max-w-lg text-center opacity-80">
            © {brand.year} {brand.name} · {brand.location}
          </p>
        </div>
      </div>
    </footer>
