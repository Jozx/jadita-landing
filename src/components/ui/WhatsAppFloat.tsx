...
const WhatsAppFloat: React.FC<WhatsAppFloatProps> = ({ url }) => {
  return (
    <a
      href={url}
      target="_blank"
      ...
      className="fixed bottom-6 right-6 z-50 md:hidden flex items-center justify-center bg-[#25D366] text-white rounded-full p-4 shadow-xl whatsapp-pulse transition-transform duration-300 hover:scale-110"
    >
